...
> 🧿The Mystic Bot Remastered 🧿

${tradutor.texto1[2]}

${tradutor.texto1[3]} ${level} 📊
${tradutor.texto1[4]} ${exp} ⚜️
${tradutor.texto1[5]} ${role} ⚔️
${tradutor.texto1[6]} ${limit} ♾️
...
${tradutor.texto1[9]} ${user.premiumTime > 0 ? '✅' : (isPrems ? '✅' : '❌') || ''}
 ...
 ${tradutor.texto1[10]}
  ...
  ╭───── • ◆ • ─────╮
  ├➼ _${usedPrefix}serbot --code_ 🛠️
  ├➼ _${usedPrefix}serbot_ 🛠️
  ...
  ├➼ _${usedPrefix}disable antispam_ ✔️
  ...
  ├➼_${usedPrefix}disable antiprivado_ ✔️
  ╰───── • ◆ • ─────╯
  ...
  ├➼ _${usedPrefix}ppt *<papel / tijera /piedra>*_ ✂️
  ├➼ _${usedPrefix}prostituto *<nombre / @tag>*_ 🚹
  ├➼ _${usedPrefix}prostituta *<nombre / @tag>*_ 🚺
  ├➼ _${usedPrefix}gay2 *<nombre / @tag>*_ 🌈
  ├➼ _${usedPrefix}lesbiana *<nombre / @tag>*_ 🏳️‍⚧️
  ...
  ├➼ _${usedPrefix}love *<nombre / @tag>*_ ❤️
  ├➼ _${usedPrefix}doxear *<nombre / @tag>*_ 🔎
  ├➼ _${usedPrefix}pregunta *<txt>*_ ❓
  ├➼ _${usedPrefix}suitpvp *<@tag>*_ ⚔️
  ├➼ _${usedPrefix}slot *<apuesta>*_ 🎰
  ├➼ _${usedPrefix}ttt ${tradutor.texto1[32]} 🕹️
  ...
  ├➼ _${usedPrefix}formarpareja_ ❤️
  ├➼ _${usedPrefix}verdad_ 💭
  ├➼ _${usedPrefix}reto_ 🏆
  ├➼ _${usedPrefix}cancion_ 🎶
  ├➼ _${usedPrefix}pista_ 🕵️‍♂️
  ...
  ├➼ _${usedPrefix}enable *detect*_ 🛡️
  ├➼ _${usedPrefix}disable *detect*_ 🚫
  ├➼ _${usedPrefix}enable *audios*_ 🎶
  ├➼ _${usedPrefix}disable *audios*_ 🚫
  ├➼ _${usedPrefix}enable *autosticker*_ 🖼️
  ├➼ _${usedPrefix}disable *autosticker*_ 🚫
  ├➼ _${usedPrefix}enable *antiviewonce*_ 👁️
  ├➼ _${usedPrefix}disable *antiviewonce*_ 🚫
  ├➼ _${usedPrefix}enable *antitoxic*_ ☣️
  ├➼ _${usedPrefix}disable *antitoxic*_ 🚫
  ├➼ _${usedPrefix}enable *antitraba*_ 🛡️
  ...
  ├➼ _${usedPrefix}enable *antidelete*_ 🗑️
  ...
  ╭───── • ◆ • ─────╮
  ├➼❧ _${usedPrefix}play *<txt>*_ ⬇️🎞️
  ├➼❧ _${usedPrefix}play2 *<txt>*_ ⬇️🎞️
  ├➼❧ _${usedPrefix}play.1 *<txt>*_ ⬇️🎞️
  ├➼❧ _${usedPrefix}play.2 *<txt>*_ ⬇️🎞️
  ├➼❧ _${usedPrefix}playdoc *<txt>*_ ⬇️📁
  ├➼❧ _${usedPrefix}playdoc2 *<txt>*_ ⬇️📁
  ├➼❧ _${usedPrefix}playlist *<txt>*_ ⬇️📼
  ├➼❧ _${usedPrefix}ytshort *<url>*_ ⬇️🎥
  ├➼❧ _${usedPrefix}ytmp3 *<url>*_ ⬇️🎧
  ├➼❧ _${usedPrefix}ytmp3doc *<url>*_ ⬇️🎧📁
  ├➼❧ _${usedPrefix}ytmp4 *<url>*_ ⬇️🎞️
  ├➼❧ _${usedPrefix}ytmp4doc *<url>*_ ⬇️🎞️📁
  ├➼❧ _${usedPrefix}videodoc *<url>*_ ⬇️🎥📁
  ├➼❧ _${usedPrefix}spotify *<txt>*_ ⬇️🎧
  ├➼❧ _${usedPrefix}facebook *<url>*_ ⬇️🔗
  ├➼❧ _${usedPrefix}instagram *<url>*_ ⬇️🔗
  ├➼❧ _${usedPrefix}igstory *<usr>*_ ⬇️🔗
  ├➼❧ _${usedPrefix}tiktok *<url>*_ ⬇️🔗
  ├➼❧ _${usedPrefix}tiktokimg *<url>*_ ⬇️🔗
  ├➼❧ _${usedPrefix}pptiktok *<usr>*_ ⬇️🔗
  ├➼❧ _${usedPrefix}mediafire *<url>*_  ⬇️📁
  ├➼❧ _${usedPrefix}pinterest *<txt>*_ ⬇️🖼️
  ├➼❧ _${usedPrefix}gitclone *<url>*_ ⬇️📁
  ├➼❧ _${usedPrefix}gdrive *<url>*_ ⬇️📁
  ├➼❧ _${usedPrefix}twitter *<url>*_ ⬇️🔗
  ├➼❧ _${usedPrefix}ringtone *<txt>*_ ⬇️🎼
  ├➼❧ _${usedPrefix}soundcloud *<txt>*_ ⬇️🎶
  ├➼❧ _${usedPrefix}stickerpack *<url>*_ ⬇️🖼️📁
  ├➼❧ _${usedPrefix}wallpaper *<txt>*_ ⬇️🖼️
  ├➼❧ _${usedPrefix}dapk2 *<url>*_ ⬇️👾
 ...
 ${tradutor.texto1[16]}
  ...
  ├➼❧ _${usedPrefix}stickersearch *<txt>*_ 🖼️
  ├➼❧ _${usedPrefix}stickersearch2 *<txt>*_ 🖼️
  ├➼❧ _${usedPrefix}xnxxsearch *<txt>*_ 🔞
  ├➼❧ _${usedPrefix}animeinfo *<txt>*_ 🍥
  ├➼❧ _${usedPrefix}google *<txt>*_ 🧭
  ├➼❧ _${usedPrefix}letra *<txt>*_ ⌨️
  ├➼❧ _${usedPrefix}wikipedia *<txt>*_ 👩‍🔬
  ├➼❧ _${usedPrefix}ytsearch *<txt>*_ 🎞️
  ├➼❧ _${usedPrefix}playstore *<txt>*_ ▶️
  ╰───── • ◆ • ─────╯
