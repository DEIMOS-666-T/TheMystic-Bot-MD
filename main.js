...
mobile: MethodMobile, 
browser: opcion == '1' ? ['TheMystic-Bot Remastered-MD', 'Safari', '2.0.0'] : methodCodeQR ? ['TheMystic-Bot-MD', 'Safari', '2.0.0'] : ['Ubuntu', 'Chrome', '20.0.04'],
auth: {
creds: state.creds,
...
global.reloadHandler = async function(restatConn) {
  ...
  conn.sDesc = '*[ ℹ️ ] La descripción del grupo ha sido modificada.✏️*';
  conn.sSubject = '*[ ℹ️ ] El nombre del grupo ha sido modificado.✏️*';
  conn.sIcon = '*[ ℹ️ ] Se ha cambiado la foto de perfil del grupo.✏️*';
